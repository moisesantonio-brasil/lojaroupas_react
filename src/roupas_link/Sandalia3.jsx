...
import Imagem from "/Users/moise/Desktop/Projetos/REACT/LOJA_ROUPAS/loja_roupas/src/imagens/sandália_feminina/Sandalia06.png"
...
return(
   ...
   <section style={fundo_global}>
       ...
       <h1 style={titulo_produto}>Sandália Pérola</h1>
    
       <h2 style={{marginTop:"30px",textAlign:"center",
       fontFamily:"monospace",fontSize:"30px"}}>R$ 84,00</h2>
       <p style={{fontFamily:"Helvetica",marginLeft:"15px",
   marginBottom:"50px"}}>2X de 43,80 sem juros</p>
      ...
      backgroundColor:"none",display:"flex",flexWrap:"wrap"}}>
       <button style={{width:"60px",height:"30px",marginLeft:"10px"}}>38</button>
       <button style={{width:"60px",height:"30px",marginLeft:"10px"}}>39</button>
       <button style={{width:"60px",height:"30px",marginLeft:"10px"}}>40</button>
      </div>
