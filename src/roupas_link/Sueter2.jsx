...
import Imagem from "/Users/moise/Desktop/Projetos/REACT/LOJA_ROUPAS/loja_roupas/src/imagens/blusa_feminina_frio/sueter02.png"
...
return(
   ...
   <section style={fundo_global}>
       ...
       <h1 style={titulo_produto}>Suéter de Listras</h1>
    
       <h2 style={{marginTop:"30px",textAlign:"center",
       fontFamily:"monospace",fontSize:"30px"}}>R$ 85,90</h2>
       <p style={{fontFamily:"Helvetica",marginLeft:"15px",
   marginBottom:"50px"}}>2X de 45,80 com juros</p>
