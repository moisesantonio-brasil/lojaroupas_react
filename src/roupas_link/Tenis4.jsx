...
import Imagem from "/Users/moise/Desktop/Projetos/REACT/LOJA_ROUPAS/loja_roupas/src/imagens/Tenis/Tenis10.png"
...
return(
   ...
   <section style={fundo_global}>
       ...
       <h1 style={titulo_produto}>Tênis Nike</h1>
    
       <h2 style={{marginTop:"30px",textAlign:"center",
       fontFamily:"monospace",fontSize:"30px"}}>R$ 250,00</h2>
       <p style={{fontFamily:"Helvetica",marginLeft:"15px",
   marginBottom:"50px"}}>4X de 64,80 sem juros</p>
