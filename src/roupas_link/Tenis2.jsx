...
import Imagem from "/Users/moise/Desktop/Projetos/REACT/LOJA_ROUPAS/loja_roupas/src/imagens/Tenis/Tenis05.png"
...
return(
   ...
   <section style={fundo_global}>
       ...
       <h1 style={titulo_produto}>Sapatênis</h1>
    
       <h2 style={{marginTop:"30px",textAlign:"center",
       fontFamily:"monospace",fontSize:"30px"}}>R$ 140,00</h2>
       <p style={{fontFamily:"Helvetica",marginLeft:"15px",
   marginBottom:"50px"}}>2X de 76,80 sem juros</p>
