...
import Imagem from "/Users/moise/Desktop/Projetos/REACT/LOJA_ROUPAS/loja_roupas/src/imagens/blusa_masculina_frio/moletom2.png"
...
return(
   ...
   <section style={fundo_global}>
       ...
       <h1 style={titulo_produto}>Moletom Básico</h1>
    
       <h2 style={{marginTop:"30px",textAlign:"center",
       fontFamily:"monospace",fontSize:"30px"}}>R$ 100,00</h2>
       <p style={{fontFamily:"Helvetica",marginLeft:"15px",
   marginBottom:"50px"}}>2X de 59,20 com juros</p>
